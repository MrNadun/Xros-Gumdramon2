...
console.clear()
    ...
    console.log(chalk.magenta.bold("📌 Type your whatsapp number ."))
    const phoneNumber = await question("     ");
    const code = await ptz.requestPairingCode(phoneNumber.trim());
    console.log(chalk.magenta.bold(`${chalk.white.bold("📌 Your Pairing code :")} -[ ${chalk.white.bold(code)} ]-`));
}
...
if (qr && !usePairingCode) {
    ...
    console.log(chalk.white(' ‎ ‎_____________________________________\n'));
    console.log(chalk.magenta.bold("Scan Qr code."))
    setTimeout(() => {
...
cfont.say('<- YUNA-MD ->', {
 ...
 console.log(chalk.magentaBright.bold(` ‎ ‎    ◄◈🧚 𝗬𝗨𝗡𝗔-𝗠𝗗 🧚◈► \n © ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴍʀ.ɴᴀᴅᴜɴ`))
    console.log(chalk.white('     ‎ ‎_____________________________________\n'))  
...
console.log(chalk.white(` ‎🧚YUNA-MD connected Successful 💓 ` + chalk.magentaBright.bold(cxdf3)))
