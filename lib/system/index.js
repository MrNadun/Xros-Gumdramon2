...
if (!credsExist()) {
console.clear()
const optionauth = await question(chalk.magenta.bold(`\n${chalk.green.bold("「🧚 𝙋𝙡𝙚𝙖𝙨𝙚 𝙎𝙚𝙡𝙚𝙘𝙩 𝙮𝙤𝙪𝙧 𝙛𝙖𝙫𝙤𝙧𝙞𝙩𝙚 𝙤𝙥𝙩𝙞𝙤𝙣」")}\n\n1. Scan QR ${chalk.red.bold("[Connecte with useing QR code ]")}\n2. Pairing Code ${chalk.white.bold("[ Connecte with useing pair code ]")}\n◄◈ Selecte your favourite option's Number ${chalk.white.bold("1")} atau ${chalk.white.bold("2")}\n${chalk.white.bold("•")} ──> `));
 usePairingCode = optionauth.trim() === '2';
}
const browserOption = usePairingCode ? ['YUNA-MD', 'Chrome', '20.0.04'] : ['YUNA-MD', 'Chrome', '3.0.0'];
...
console.clear()
    console.log(chalk.green.bold(`\n\n ‎ ‎  ◄◈🧚 𝗬𝗨𝗡𝗔-𝗠𝗗 𝗣𝗔𝗜𝗥 𝗖𝗢𝗗𝗘 𝗚𝗘𝗡𝗘𝗥𝗔𝗧𝗢𝗥 🧚◈► \n © ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴍʀ.ɴᴀᴅᴜɴ `));
    console.log(chalk.red(' ‎ ‎_____________________________________\n'));
    console.log(chalk.blue.bold("📌 Type your whatsapp number ."))
    const phoneNumber = await question("     ");
    const code = await ptz.requestPairingCode(phoneNumber.trim());
    console.log(chalk.magenta.bold(`${chalk.blue.bold("📌 Your Pairing code :")} -[ ${chalk.white.bold(code)} ]-`));
}
...
if (qr && !usePairingCode) {
    console.log(chalk.green.bold(`\n\n ‎ ‎  ◄◈🧚 𝗬𝗨𝗡𝗔-𝗠𝗗 𝗤𝗥 𝗖𝗢𝗗𝗘 𝗚𝗘𝗡𝗘𝗥𝗔𝗧𝗢𝗥 🧚◈► \n © ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴍʀ.ɴᴀᴅᴜɴ`));
    console.log(chalk.red(' ‎ ‎_____________________________________\n'));
    console.log(chalk.blue.bold("Scan Qr code."))
    setTimeout(() => {
...
cfont.say('<- YUNA-MD ->', {
 ...
 console.log(chalk.green.bold(` ‎ ‎    ◄◈🧚 𝗬𝗨𝗡𝗔-𝗠𝗗 🧚◈► \n © ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴍʀ.ɴᴀᴅᴜɴ`))
    console.log(chalk.red('     ‎ ‎_____________________________________\n'))  
...
let respon = `
 ╭ > ${chalk.bgGreen("[ S E R V E R - U S E D ]")}
...
console.log(chalk.green(` ‎🧚YUNA-MD connected Successful 💓 ` + chalk.magentaBright.bold(cxdf3)))
